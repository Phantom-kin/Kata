 ...
 smd({
   ...
   try {
     ...
     try {
       ...
       _0x160b96.reply("*_✅Group description Updated Successfuly! by Phanto🐲_*");
     } catch (_0x986809) {
 ...
 smd({
   ...
   try {
     ...
     if (_0x6118c5.startsWith("sure") || _0x6118c5.startsWith("ok") || _0x6118c5.startsWith("yes")) {
       ...
       _0x37841c.send("*Perseants 😂😂!!*", {}, "", _0x37841c, _0x37841c.user);
     } else {
 ...
 smd({
   ...
   try {
     ...
     if (!_0xc0618e || !mtypes.includes(_0xc0618e?.mtype || "need_Media")) {
       return await _0x5ac912.reply("*Reply to an image, bruh*");
     }
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x502431 of _0x5d614a) {
       if (!_0x502431.id.startsWith("277482xxxx")) {
 ...
 cmd({
   ...
   try {
     ...
     for (let _0x723896 of _0x5f29e6) {
       ...
       if (_0x723896.id.startsWith(_0x35a368) && !_0x527887 && _0x723896.id !== _0x19564c.user && !_0x723896.id.startsWith("27748xxxxx")) {
         if (!_0xff4f2e) {
           _0xff4f2e = true;
