...
smd(
  ...
  async (m) => {
    try {
      ...
      await m.send("𝕻𝖍𝖆𝖓𝖙𝖔𝖒 is thinking 🤔");
  ...
  try {
    ...
    if (contentType && contentType.startsWith('image')) {
      ...
      await m.bot.sendFromUrl(
        m.from,
        photoUrl,
        "*Phantom-Error generated this photo*:",
        m,
        {},
        "image"
      );
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("Phantom-Error • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("Phantom-Error • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*Phantom-Error • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
